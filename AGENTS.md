1. never to use .git data of another directory from outside project workflow
2. não use nunca mais o && no git, use sempre ;
3. por padrão use o gitbash para rodar terminal
4. Nunca usar PowerShell se for possível rodar de outro modo;
